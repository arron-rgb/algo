...
public class ReverseBits {
  ...
  //
  // Related Topics Divide and Conquer Bit Manipulation 👍 3418 👎 881
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < loop; i++) {
      int q = solution.reverseBits((int)params[1 + i * paramTypes.length - 1]);
      System.out.println("00000010100101000001111010011100".equals(Integer.toBinaryString(q)));
    }
  }
