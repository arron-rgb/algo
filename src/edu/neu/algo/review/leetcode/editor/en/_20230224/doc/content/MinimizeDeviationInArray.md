...
<ul>
<li>For example, if the array is <code>[1,2,3,4]</code>, then you can do this operation on the last element, and the array will be[1,2,3,<u>2</u>]</li>
</ul>
...
<div><div>Related Topics</div><div><li>Array</li><li>Greedy</li><li>Heap (Priority Queue)</li><li>Ordered Set</li></div></div><br><div><li>👍 2454</li><li>👎 129</li></div>
