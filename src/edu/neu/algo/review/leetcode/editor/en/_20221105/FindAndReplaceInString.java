...
public class FindAndReplaceInString {
  ...
  //
  // Related Topics Array String Sorting 👍 975 👎 888
  ...
  public static void main(String[] args) {
    ...
    String[] paramTypes = InputUtil.param("[String, int[], String[], String[]]");
    ...
    for (int i = 0; i < loop; i++) {
      String q = solution.findReplaceString((String)params[1 + i * paramTypes.length - 1],
        (int[])params[2 + i * paramTypes.length - 1], (String[])params[3 + i * paramTypes.length - 1],
        (String[])params[4 + i * paramTypes.length - 1]);
