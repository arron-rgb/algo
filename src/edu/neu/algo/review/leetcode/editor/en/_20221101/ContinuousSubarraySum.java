...
public class ContinuousSubarraySum {
  ...
  // 1 <= k <= 2³¹ - 1
  //
  // Related Topics Array Hash Table Math Prefix Sum 👍 4142 👎 405
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < loop; i++) {
      boolean q = solution.checkSubarraySum((int[])params[1 + i * paramTypes.length - 1],
