...
public class MergeTwoSortedLists {
  ...
  //
  // Related Topics Linked List Recursion 👍 16325 👎 1439
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < loop; i++) {
      ListNode q = solution.mergeTwoLists((ListNode)params[1 - 1 + i * paramTypes.length],
        (ListNode)params[2 - 1 + i * paramTypes.length]);
